...
const navItems = [
  ...
  { icon: ICONS.SPORT, label: "СПОРТ" },
  { icon: ICONS.ESPORT, label: "КІБЕРСПОРТ" },
  { icon: ICONS.FORUM, label: "ФОРУМ" },
];

const Header = () => {
  return (
    <header className="w-full h-[172px] flex justify-center bg-white rounded-b-[20px] shadow-sm overflow-hidden">
      <div className="w-full max-w-[1360px] px-10 pt-[11px] flex flex-col gap-4">
