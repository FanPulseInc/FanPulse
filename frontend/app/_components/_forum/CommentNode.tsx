...
export default function CommentNode({ comment, depth, postId, postAuthorId }: CommentNodeProps) {
    ...
    return (
        <div className="relative">
            ...
            <div className="flex flex-col bg-surface rounded-[20px] shadow-sm border border-border-theme overflow-visible">
                <div className="bg-[#212121] h-[37px] px-4 flex justify-between items-center rounded-[20px] relative">
                    <span className="text-white text-[11px] font-bold flex items-center gap-2">
                        <button
                            type="button"
                            onClick={(e) => openAuthorProfile(e, comment.user?.id)}
        ...
        "
                        >
                            {comment.user?.name ?? t("forum_anonymous")}
                        </button>
                        {isAuthor && (
                ...
                <div className="p-4 flex justify-between items-center bg-surface rounded-b-[20px]">
                    <p className="text-sm text-text-primary font-medium">{comment.commentText}</p>
                    ...
                    <div className="px-4 pb-4 flex flex-col gap-2">
                        ...
                        <div className="flex justify-end gap-2">
                            <button
                                ...
                                className="h-[32px] px-4 rounded-full text-[11px] font-bold border border-border-theme hover:bg-surface-secondary transition cursor-pointer"
                            >
                                {t("cancel")}
                            </button>
                            <button
