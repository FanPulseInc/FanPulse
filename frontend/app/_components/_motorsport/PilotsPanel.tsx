...
function Row({ p }: { p: Pilot }) {
    ...
    return (
        <div className="grid grid-cols-[40px_44px_1fr_auto] items-center gap-3 py-[10px] border-b border-border-theme last:border-none">
            ...
            <div className="flex flex-col min-w-0">
                ...
                <span className="text-[11px] bg-surface-tertiary px-2 py-[2px] rounded inline-block self-start truncate max-w-full">
                    {p.teamOrCar}
                </span>
            </div>
...
export default function PilotsPanel({ pilots, isLive }: Props) {
    ...
    return (
        <div className="w-full flex flex-col gap-2">
            <div className="w-full bg-surface rounded-[14px] shadow-sm border border-border-theme flex flex-col p-3">
            ...
            {isLive && (
                <div className="w-full flex items-center justify-center gap-3 mt-1">
                    <span className="bg-surface text-[#af292a] text-[10px] font-bold uppercase px-2 py-[2px] rounded-full border border-[#af292a]">
                        Live
                    </span>
                </div>
            )}
