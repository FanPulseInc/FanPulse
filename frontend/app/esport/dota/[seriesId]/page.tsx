...
export default function DotaMatchPage() {
  ...
  if (loading) {
    return (
      <main className="flex min-h-[500px] items-center justify-center bg-background text-sm font-black text-text-primary">
        Завантаження...
      </main>
    );
  }
          ...
          <div className="px-5 pb-5 pt-5 md:px-7 md:pb-6">
            ...
            <div className="mt-6 grid grid-cols-[1fr_120px_1fr] items-center gap-3 md:grid-cols-[1fr_170px_1fr] md:gap-5">
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <div className="mt-3 rounded-full bg-surface px-5 py-1.5 text-[11px] font-black uppercase tracking-[0.14em] text-[#af292a] shadow-md md:text-[13px]">
                  {statusLabel}
                </div>
